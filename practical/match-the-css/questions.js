...
const ELEMENTS_QUESTIONS = [
  ...
  // ── Hard (el21-el30): exactly 1 property changed, but a clear delta ──
  {
    ...
    choices: [
      { id: "a", overrides: {} },
      { id: "b", overrides: { ".btn-sm": { padding: "9px 26px" } } },
      { id: "c", overrides: { ".btn-sm": { "border-radius": "16px" } } },
      { id: "d", overrides: { ".btn-sm": { background: "#60a5fa" } } },
      { id: "e", overrides: { ".btn-sm": { "font-size": "18px" } } },
    ],
    correctChoiceId: "a",
  ...
  },
  {
    ...
    choices: [
      { id: "a", overrides: {} },
      { id: "b", overrides: { ".tag-sm": { padding: "3px 18px" } } },
      { id: "c", overrides: { ".tag-sm": { color: "#7dd3fc" } } },
      { id: "d", overrides: { ".tag-sm": { "font-size": "15px" } } },
  ...
  },
  {
    ...
    choices: [
      { id: "a", overrides: {} },
      { id: "b", overrides: { ".info-box": { padding: "10px 24px" } } },
      { id: "c", overrides: { ".info-box": { "border-radius": "18px" } } },
      { id: "d", overrides: { ".info-box": { border: "1px solid #38bdf8" } } },
      { id: "e", overrides: { ".info-box": { "font-size": "17px" } } },
    ],
    correctChoiceId: "a",
  ...
  },
  {
    ...
    choices: [
      { id: "a", overrides: {} },
      { id: "b", overrides: { ".tab-sm": { padding: "7px 24px" } } },
  ...
  },
  {
    ...
    choices: [
      { id: "a", overrides: {} },
      { id: "b", overrides: { ".avatar-sm": { width: "46px", height: "46px" } } },
      { id: "c", overrides: { ".avatar-sm": { background: "#c4b5fd" } } },
      { id: "d", overrides: { ".avatar-sm": { "font-size": "18px" } } },
  ...
  },
  {
    ...
    choices: [
      { id: "a", overrides: {} },
      { id: "b", overrides: { ".field-sm": { padding: "8px 20px" } } },
      { id: "c", overrides: { ".field-sm": { "border-radius": "14px" } } },
      { id: "d", overrides: { ".field-sm": { border: "3px solid #cbd5e1" } } },
  ...
  },
  {
    ...
    choices: [
      { id: "a", overrides: {} },
      { id: "b", overrides: { ".tooltip-sm": { padding: "5px 20px" } } },
      { id: "c", overrides: { ".tooltip-sm": { "border-radius": "16px" } } },
      { id: "d", overrides: { ".tooltip-sm": { background: "#4b5563" } } },
      { id: "e", overrides: { ".tooltip-sm": { "font-size": "15px" } } },
    ],
    correctChoiceId: "a",
  ...
  },
  {
    ...
    choices: [
      { id: "a", overrides: {} },
      { id: "b", overrides: { ".row-sm": { gap: "18px" } } },
      { id: "c", overrides: { ".mark": { width: "14px", height: "14px" } } },
      { id: "d", overrides: { ".mark": { background: "#a7f3d0" } } },
      { id: "e", overrides: { ".row-sm": { "font-size": "18px" } } },
    ],
    correctChoiceId: "a",
  ...
  },
  {
    ...
    choices: [
      { id: "a", overrides: {} },
      { id: "b", overrides: { ".chip-sm": { padding: "3px 20px" } } },
      { id: "c", overrides: { ".chip-sm": { color: "#fca5a5" } } },
      { id: "d", overrides: { ".chip-sm": { "border-radius": "6px" } } },
      { id: "e", overrides: { ".chip-sm": { "font-size": "16px" } } },
    ],
    correctChoiceId: "a",
  ...
  },
  {
    ...
    choices: [
      { id: "a", overrides: { ".card": { padding: "16px 30px" } } },
      { id: "b", overrides: { ".card": { "border-radius": "22px" } } },
      { id: "c", overrides: {} },
...
const WHOLE_PAGE_QUESTIONS = [
  ...
  <footer class="site-footer">Tokyo Eats</footer>
    ...
    choices: [
      { id: "a", overrides: {} },
      { id: "b", overrides: { ".shop-row": { padding: "13px 30px" } } },
      { id: "c", overrides: { ".shop-list": { gap: "10px" } } },
      { id: "d", overrides: { ".shop-tag": { color: "#fdba74" } } },
      { id: "e", overrides: { ".hero": { padding: "50px 60px" } } },
    ],
    correctChoiceId: "a",
  ...
  <footer class="site-footer">Sakura Watch</footer>
    ...
    choices: [
      { id: "a", overrides: {} },
      { id: "b", overrides: { ".card": { padding: "32px" } } },
      { id: "c", overrides: { ".card": { "border-radius": "26px" } } },
      { id: "d", overrides: { ".card h3": { color: "#f472b6" } } },
      { id: "e", overrides: { ".card p": { "font-size": "22px" } } },
    ],
    correctChoiceId: "a",
